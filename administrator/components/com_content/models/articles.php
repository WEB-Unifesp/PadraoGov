...
protected function getListQuery()
	{
		...
		$user  = JFactory::getUser();
		 ...
		 //******** TRECHO MODIFICADO - VERIFICA SE O USUARIO E SUPER ADMIN *****************//
		 ...
		 //********* TRECHO MODIFICADO - trazendo a tag do usuario logado ------------------------//
		...
		//******** TRECHO MODIFICADO - ACRESCENTA TABELA DAS FIELDS *****************//
		if(!$adminL){
			$query->select('fv.value')
			->join('LEFT', '#__fields_values AS fv ON fv.item_id=a.created_by');
		}
		...
		//******** TRECHO MODIFICADO - COMPARA FIELD DO USUARIO QUE CADASTROU CONTEUDO COM A FIELD DO USUARIO LOGADO *****************//	
		if(!$adminL){
			$query->where('(fv.value = '.$tag.')');
		}
